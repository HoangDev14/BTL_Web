...
<head>
	<title>StarBook Tìm vé bay</title>
	<meta charset="utf-8">
	...
	<div class="container-fluid" style="background-color: #e8e8e8;">
				...
				<nav class="navbar navbar-expand-lg navbar-light bg-light navbar-dark bg-dark">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						...
						<ul class="navbar-nav ml-md-auto">
							<li class="nav-item active">
								<a class="nav-link"  href="phplogin/register.php" >Đăng ký <span class="sr-only">(current)</span></a>
							</li>
							<a  style="color: white;background: blue;" href="phplogin/login.php" class="btn btn-secondary">đăng nhâp</a>
						</ul>
		...
		<div class="row">
			...
			<div>
				...
				<input type="text" name="DiemDi" value="seach">
				<label>Điểm đến</label>
				<input type="text" name="DiemDen" value="seach1">
			...
			<div class="row" style="margin-top: 5px;">
				...
				<div class="col-md-8 row hove" style="width: 940px; cursor: pointer;height: 180px;" onclick="window.location='file:///C:/xampp/htdocs/StarBook/html/trangchu.html';">
					<div>
						...
						<label style="margin-left: 85px;"><?php echo $value['GioBay'] ?></label>
						<label style="margin-left: 85px;"><?php echo $value['GioDen'] ?></label>
